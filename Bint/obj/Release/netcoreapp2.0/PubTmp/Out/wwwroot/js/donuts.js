...
var DashboardDonuts = function() {
    ...
    var _MarketingCampaignsDonutChart = function(element, size) {
        ...
        if($(element).length > 0) {
            ...
            // Colors
            var colorrange = ['#FF7043','#66BB6A','#9575CD'];
            ...
            var tip = d3.tip()
                ...
                .html(function (d) {
                    return '<ul class="list-unstyled mb-1">' +
                        '<li>' + '<div class="font-size-base mb-1 mt-1">' + d.data.icon + d.data.browser+' : ' + d.value + '</div>' + '</li>' +
    ...
    return {
        init: function() {
            ...
            _MarketingCampaignsDonutChart('#mycamp-donut', 42);
